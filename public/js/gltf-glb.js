...
const gltfCovertSection = document.querySelector(".gltf_converter");
const gltfCovertBtn = document.getElementById("gltf_convert_btn");

gltfCovertBtn.onclick = function () {
  gltfCovertSection.style.display = "flex";
};

gltfCovertSection.onclick = function () {
  gltfCovertSection.style.display = "none";
};
