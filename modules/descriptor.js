...
var outputPath = '/public/descriptors/';
...
let makeDes = async function(srcImg){
    
    srcImage = path.join(__dirname, srcImg);

    if(true){
        outputPath = "/public/descriptors/";
